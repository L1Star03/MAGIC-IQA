...
model = dict(
    ...
    generator=dict(
        ...
        ['well exposed photo, good photo.', 'white out overexposed photo, bad photo.'],  # Bright1 
        ['well exposed photo, good photo.', 'black out underexposed photo, bad photo.'], # Bright2
        ['color fit photo, good photo.', 'oversaturated photo, bad photo.'], # Color1(Edit)
        ['color fit photo, good photo.', 'dull photo, bad photo.'], # Color2(Edit)
        ['high contrast photo, good photo.', 'low contrast photo, bad photo.'], # Contrast
        ]),

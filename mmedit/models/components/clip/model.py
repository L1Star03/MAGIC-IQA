...
class ModifiedResNet(nn.Module):
    ...
    def _make_layer(self, planes, blocks, stride=1):
        """
        Create a residual layer with the given number of blocks and planes.
        """
    ...
    def forward(self, x, return_token=False, pos_embedding=False):
        ...
        def stem(x):
            """
            Apply the stem convolutions to the input.
            """
...
class CLIP(nn.Module):
    ...
    def forward(self, image, text, pos_embedding=False):
